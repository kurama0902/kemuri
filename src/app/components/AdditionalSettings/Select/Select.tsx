...
export const Select = ({ text, vae, handleSetVae, samplingMethod, handleSetSamplingMethod, upscaleMethod, handleSetUpscaleMethod, selectedLoras, loraWeights, handleSetLoraWeights }: {
    text: string,
    vae?: string,
    ...
    // console.log(selectedLoras, 'selected loras');
        ...
        <div className={s.wrap}>
            ...
            <div className={`${s.selectWrap}`}>
                ...
                <div className={`${s.options} ${isShowSelect === null ? '' : isShowSelect ? s.show : s.close}`}>
                    ...
                    {(text === 'Lora Weight' && loraWeights !== undefined) && selectedLoras?.map((el, index)=> {
                        return (
